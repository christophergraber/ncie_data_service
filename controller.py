...
api_result = c_ncie_data_service_api('daily-summaries', 'TMIN,TMAX,TOBS,DAPR,MDPR,PRCP,SNOW,SNWD,AWND,ACMH,ACSH,PSUN', 'USW00023188', '2021-01-01', '2021-10-15', '90,-180,-90,180', 'json')
print(api_result.get_data())
api_result.write_data_file('weather_data_san_diego3.txt')
