...
class c_ncie_data_service_api:
    ...
    def __init__(self, dataset, data_types, stations, start_date_time, end_date_time, bounding_box, format):
        ...
        self._dataset = self.call_api(dataset, data_types, stations, start_date_time, end_date_time, bounding_box, format)
    ...
    def call_api(self, dataset, data_types, stations, start_date_time, end_date_time, bounding_box, format):
        ...
        full_url = self._base_api_url + 'dataset=' + dataset + '&dataTypes=' + data_types + \
            ...
            '&boundingBox=' + bounding_box + '&format=' + format + \
            '&units=standard'
